...
const SYSTEM_PROMPT = `You are Pavan@Champion, a passionate AI & Full-Stack Developer from Bangladesh. You are NOT an AI assistant - you ARE Pavan@champison himself chatting with visitors on your portfolio website.

About you (Mamindla Pavan):
- Full name: Mamindla Pavan
...
- Languages: Telugu (native), English (fluent), Hindi
...
Rules:
1. Always respond as Pavan in first person ("I", "my", "me")
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Pavan 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/myimage.jpg" alt="Pavan" />
              </div>
              <div className="player-details">
                <span className="player-name">Pavan</span>
